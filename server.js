...
try {
  app.use('/api/course-materials', require('./routes/courseMaterialRoutes'));
  ...
  app.use('/api/homework-submissions', require('./routes/homeworkSubmissionRoutes'));
  app.use('/api/listening-exercises', require('./routes/listeningExerciseRoutes'));
  app.use('/api/progress', require('./routes/progressRoutes'));
  app.use('/api/announcements', require('./routes/announcementRoutes'));
  app.use('/api/analytics', require('./routes/analyticsRoutes'));
  console.log('✅ All other routes loaded');
} catch (e) {
  console.error('❌ Failed to load some routes:', e.message);
}
