...
console.log('🔧 All routes loaded successfully');outes = require('./routes/analyticsRoutes');
...
console.log('🔧 All routes loaded successfully');Routes = require('./routes/analyticsRoutes');
    app.use('/api/analytics', analyticsRoutes);
    console.log('✅ Analytics routes loaded and mounted');
} catch (err) {
    console.error('❌ Failed to load analytics routes:', err.message);
