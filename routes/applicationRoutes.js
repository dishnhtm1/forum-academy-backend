...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      console.log(
        `✅ Application status updated successfully: ${application.firstName} ${application.lastName}`
      );
      res.json({
        success: true,
        message: "Application status updated",
...
router.patch(
  ...
  async (req, res) => {
    try {
      ...
      console.log(
        `📝 PATCH: Updating application ${applicationId} status to: ${status}`
      );
...
router.delete(
  ...
  async (req, res) => {
    try {
      ...
      console.log(
        `👤 Found application: ${application.firstName} ${application.lastName} (${application.email})`
      );
      console.log(`🗑️ Deleting application...`);
      ...
      console.log(
        `✅ Application deleted successfully: ${application.firstName} ${application.lastName}`
      );
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
            ...
            <div style="border-top: 1px solid #e5e7eb; padding-top: 15px; margin-top: 20px;">
                <p style="color: #6b7280; font-size: 14px; margin: 0;">
                    <strong>Regarding your application for:</strong> ${
                      application.program
                    }
                </p>
                <p style="color: #6b7280; font-size: 14px; margin: 5px 0;">
                    <strong>Application submitted:</strong> ${new Date(
